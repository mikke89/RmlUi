...
template<> const char* GetTClassName<Vector2i>();
template<> RegType<Vector2i>* GetMethodTable<Vector2i>();
template<> luaL_reg* GetAttrTable<Vector2i>();
template<> luaL_reg* SetAttrTable<Vector2i>();
}
}
}