...
#endif
{
	...
	SandboxSystemInterface sandbox_system_interface{Backend::GetSystemInterface()};
	...
	context->GetDocument("rmlui-debug-log-beacon")->SetProperty("display", "none");

	Shell::LoadFonts();

	SandboxWindow sandbox_window{&sandbox_system_interface, &sandbox_file_interface};
