...
// todo: mikke89 I really don't know how to name it correctly according by meaning it means that user passes to Backend::BeginFrame in integration
// situation but it is all necessary infromation for processing
